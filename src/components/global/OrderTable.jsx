...
const OrderTable = ({ orders, noTitlePadding }) => (
  <div className="shadow-tableBoxShadow rounded-lg border pt-5 md:py-5 border-dullishWhite m-4 md:m-0">
    ...
    <div className="px-5 ">
          ...
          {orders.map(({
            ...
            >
              <td className="text-sm p-4 w-1/5">
                ...
                <a className="text-primary">View Order</a>
              </td>
              <td className="text-sm  p-4 w-1/5">
                <span>{total}</span>
                <br />
      ...
      {orders.map(({
        ...
        >
          ...
          <a className="text-primary pb-2">View Order</a>
        </div>
      ))}
    </div>
  </div>
