...
const DeliveryModalPaused = ({ dog, openModal }) => (
      ...
      <div className="w-full p-8 flex">
        ...
        <div className="flex flex-col ml-4 w-3/5">
          ...
          <div className="text-sm mt-1">
            {dog.name}'s delivery is currently paused. Unpause to schedule your next delivery.
          </div>
          <Button
            styles="w-full mt-8"
            text="Unpause Mealplan"
            onClick={openModal}
          />
        </div>
      </div>
...
export default DeliveryModalPaused;
