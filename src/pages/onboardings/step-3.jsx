...
class ThirdStep extends Component {
  ...
  render() {
    ...
    console.log("daily_portions", this.props);
    return (
      <div>
        <div className="py-6">
          <h1 className="font-medium text-4xl mb-3">
        ...
        <div className="grid lg:grid-cols-6/4 gap-20 my-9">
          ...
          <div className="h-full border-l-2 border-gray-300 pl-12">
            ...
            <div className="p-5">
              ...
              <div className="mb-3">
                <p className="m-0 text-left">
                  ...
                  <span className="text-green-600"> $65.67 </span> every 4 weeks
                </p>
              </div>
              <div className="mb-7">
                {" "}
                <button className={`bg-green-600 border border-green-700 hover:border-transparent focus:outline-none text-white text-sm md:text-base font-bold p-1 py-3 md:px-5 w-full rounded-xl mt-2 md:mt-3`}>Save Changes</button>
              </div>
              <div className="p-4 pl-5 pr-20 h-40  flex-col bg-skinColor rounded-lg">
                <h2 className="text-lg pb-3 text-left font-semibold">Changes will apply to your <br/> March 4 delivery onwards</h2>
